...
//和Java 不一样， Kotlin 允许在lambda 内部访问非final 变量甚至修改它们。
...
//问这是什么原理。当你捕捉fi nal 变量时，它的值和使用这个值的lambda 代码一起
//存储。而对非final 变量来说，它的值被封装在一个特殊的包装器中，这样你就可以
//改变这个值，而对这个包装器的引用会和lambda 代码一起存储。
