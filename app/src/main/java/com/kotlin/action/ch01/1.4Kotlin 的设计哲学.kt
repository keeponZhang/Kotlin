...
//IDE 支持对帮助你探索Kotlin的特性也发挥着重要作用。许多情况下，工具会
...
//以在Kotlin中使用它们。可以调用Java 的方法，继承Java的类和实现Java 的接口，
//在Kotlin类上应用Java 的注解，等等。
...
//这意味着在Kotlin中调用JavaAPI 时，永远不需要包装或者转换这些Java 对象，反
//之亦然。所有这些Kotlin 提供的丰富的API 在运行时没有任何的额外开销。
//Kotlin工具也对跨语言项目提供了全面支持。它可以编译任意混合的Java 和
//Kotlin源码，不管它们之间是怎样互相依赖的。IDE 的特性也能跨语言工作，允许：
