...
import cn.kotliner.coroutine.async.我要开始协程啦自定义Context使用ContextContinuation2
import cn.kotliner.coroutine.async.我要开始耗时操作了4_2
...
//        DownloadContext(LOGO_URL)是第一个参数
        我要开始协程啦自定义Context使用ContextContinuation2() {
            log("协程开始")
            try {
                //这里相当于我要开始耗时操作了的方法参数是lambda表达式
                val imageData = 我要开始耗时操作了4_2() {
