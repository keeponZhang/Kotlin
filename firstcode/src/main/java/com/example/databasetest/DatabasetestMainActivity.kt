...
import kotlinx.android.synthetic.main.activity_main_databasetest.*

class DatabasetestMainActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main_databasetest)
...
//                }
                ...
                val values2 = contentValuesOf("name" to "Game of Thrones", "author" to "George " +
                        "Martin",
                        " pages " to 720, " price " to 20.85)
