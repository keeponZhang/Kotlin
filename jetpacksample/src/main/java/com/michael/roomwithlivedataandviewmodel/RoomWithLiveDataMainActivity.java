...
public class RoomWithLiveDataMainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        studentAdapter = new StudentAdapter(RoomWithLiveDataMainActivity.this, studentList);
    ...
    private void updateOrDeleteDialog(final Student student)
    {
        ...
        new AlertDialog.Builder(RoomWithLiveDataMainActivity.this)
                .setTitle("")
    ...
    private void openAddStudentDialog()
    {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(RoomWithLiveDataMainActivity.this);
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                {
                    Toast.makeText(RoomWithLiveDataMainActivity.this, "输入不能为空", Toast.LENGTH_SHORT).show();
                } else
                {
