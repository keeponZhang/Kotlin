...
import com.zhang.jetpacksample.databinding.ActivityIncludeLayoutBinding;
...
public class IncludeLayoutActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ActivityIncludeLayoutBinding
                activityIncludeLayoutBinding = DataBindingUtil.setContentView(this, R.layout.activity_include_layout);
