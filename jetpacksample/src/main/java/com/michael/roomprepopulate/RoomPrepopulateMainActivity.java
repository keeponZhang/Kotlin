...
public class RoomPrepopulateMainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        studentAdapter = new StudentAdapter(RoomPrepopulateMainActivity.this, studentList);
    ...
    private void updateOrDeleteDialog(final Student student)
    {
        ...
        new AlertDialog.Builder(RoomPrepopulateMainActivity.this)
                .setTitle("")
    ...
    private void openAddStudentDialog()
    {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(RoomPrepopulateMainActivity.this);
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                {
                    Toast.makeText(RoomPrepopulateMainActivity.this, "输入不能为空", Toast.LENGTH_SHORT).show();
                } else
                {
